...
checkLogin();
$SQL = "SELECT * FROM menu WHERE menu.idfood=".$_GET['food']."";
$rsty = doSelect($SQL);
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
					...
					<div class="row">
                        ...
                        <h3>NAME : <?=$row['namefood']?></h3>
                        <h3>PRICE : <t class="text-success"><?=$row['price']?></t> Bath</h3>
                    </div>
                        <div class="card-text card w-100 p-3">
                        ...
                        <?php if($row['quantity']!=0){
                         ...
                         ?>
							<a href="orderfooduser.php?food=<?=$row['idfood']?>" class="btn btn-info text-white mt-5 w-100"><b>ORDER NOW!!</b></a>
                        <?php }else{
                            echo "<h3 class=\"text-center\">Sorry,No more food.</h3>";
                        } ?>
						</div>
					</div>
				</div>
