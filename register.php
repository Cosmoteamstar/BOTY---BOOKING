...
if(isset($_POST["txtmail"])){
    ...
    if($chk["NUM"]>0){
        ...
        $SQL = "INSERT INTO register(fName,lName,phoneNumber,idcard,address,username,password)
        VALUES (\"".$_POST["txtfName"]."\",\"".$_POST["txtlName"]."\",\"".$_POST["txtphone"]."\",\"".$_POST["txtcard"]."\",\"".$_POST["txtaddr"]."\",\"".$_POST["txtmail"]."\",\"".$_POST["txtpw"]."\")";
        doSQL($SQL,"สมัครสมาชิกสำเร็จ","เกิดข้อผิดพลาด ไม่สามารถสมัครสมัครชิกได้","login.php");
    }
}
?>
<!DOCTYPE html>
				...
				<div class="col-md-10">
					<div class="row">
                        ...
                        <center><img src="assets/img/3.png" style="width:20%;"></center>
							...
							<div class="card-footer text-muted text-center mt-3"><h6>IF YOU ALREADY HAVE AN ACCOUT<br><a href="login.php">LOGIN HERE!</a></h6></div>
						</div>
					</div>
				</div>
		</div>
